...
const sketch1 = new p5(function (p) {
  ...
  p.drawNew = function (data) {
    // Return if player hasn't started playing or if playing other sketch.
    if (p.getAudioContext().state === 'suspended' || document.querySelector('#sketch1-container').style.display == 'none') {
      return
    }
